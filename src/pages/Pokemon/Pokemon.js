...
const Pokemon = props => {
  ...
  function getRndatributtes() {
    return Math.floor(Math.random() * (2000000 - 10 + 1) ) + 10;
  }
          ...
          <T.RightSideModal>
            ...
            <T.WhiteBoxContainer isProgress>
              <T.PokemonSubdataContainers>
                ...
                <T.PokemonData>{getRndatributtes()}</T.PokemonData>
                <T.ProgressPower />
              </T.PokemonSubdataContainers>
              <T.PokemonSubdataContainers>
            ...
            <T.PokemonSubdataContainers isPower>
              <T.WhiteBoxContainer isPower>
                <T.PowerLevel>{getRndstats()}</T.PowerLevel>
  ...
  return (
    <S.PokedexContainer>
      <S.PokedexHeader>
        <img onClick={goBack} src={Logo} />
        <S.MenuContainer>
          <S.MenuButton onClick={goBack}>Home</S.MenuButton>
        </S.MenuContainer>
      </S.PokedexHeader>
